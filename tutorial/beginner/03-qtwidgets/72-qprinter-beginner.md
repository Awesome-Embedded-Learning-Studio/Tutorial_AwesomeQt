---
title: "3.72 QPrinter：打印机抽象类"
description: "不管你做的是财务报表系统、工程绘图工具还是简单的文档编辑器，用户早晚有一天会指着屏幕上的内容问你：这个东西能打印出来吗？这个需求听起来平淡无奇，但如果你从零开始处理打印机驱动、页面尺寸、DPI 缩放、分页逻辑这些事情，工作量会迅速失控。"
---
