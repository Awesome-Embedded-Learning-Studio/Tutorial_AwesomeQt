---
title: "3.65 QFontDialog：字体选择对话框"
description: "上一节我们聊了 QColorDialog，用户选颜色用的。这一节轮到 QFontDialog——让用户选字体。这两个对话框在文本编辑器、绘图工具、排版软件中几乎总是成对出现：先选字体决定文字长什么样，再选颜色决定文字是什么颜色。"
---
