---
title: "5.3 QtCharts 图表基础"
description: "做应用做到一定程度，一定会遇到\"把数据画出来\"的需求。你可能觉得画图表是锦上添花的事情，但事实上，一行数字和一张折线图给人的信息量完全不在一个量级。当你的程序需要展示销售趋势、系统监控、性能分析这类数据的时候，图表不是可选的，是必须的。"
---
