---
title: "5.8 Qt Serial Bus Modbus 通信基础"
description: "如果你做的是工业自动化、能源管理、楼宇控制这类领域的软件开发，Modbus 是一个绕不开的协议。它诞生于 1979 年，最初由 Modicon 公司（现在的施耐德电气）为 PLC 通信设计，至今仍然是工业现场最广泛使用的通信协议之一。"
---
