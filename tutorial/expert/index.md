...
> 连载中 · 已完成 7 篇：本批 5 篇 QtBase 硬核基石（待审）——[01 QObject 元对象系统](01-qtbase/01-qobject-meta-system-expert.md)、[02 信号槽底层 activate 调用链](01-qtbase/02-signal-slot-internals-expert.md)、[07 事件循环源码](01-qtbase/07-event-loop-internals-expert.md)、[17 MOC 编译器原理](01-qtbase/17-moc-compiler-expert.md)、[21 对象树所有权](01-qtbase/21-object-tree-ownership-expert.md)；加已审结的 [04 COW 容器实战](01-qtbase/04-cow-container-practice-expert.md)、[19 COW 隐式共享](01-qtbase/19-cow-implicit-sharing-expert.md)。
