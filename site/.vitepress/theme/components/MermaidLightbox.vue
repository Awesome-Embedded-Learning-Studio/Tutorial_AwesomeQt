...
async function mountDiagram() {
  ...
  // width="100%" 撑成内禀尺寸(巨大、只剩左上角)。svg.viewBox.baseVal 在 detached
  // clone 上某些浏览器返回 0 → 直接解析 viewBox 属性字符串最稳("minX minY W H")。
  ...
  // 绕开 SVG 坐标系/viewBox/foreignObject 一切争议(tamcpp 研究阶段核验过)。
