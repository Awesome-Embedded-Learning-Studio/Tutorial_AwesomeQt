...
**现状（2026-08-26 更新）**：19 篇全部审结（作者确认）。QtBase 卷（21 篇）仅剩 18-signal-slot-deep-dive、20-event-loop-source 两篇即收满。**剩 83 篇。**
